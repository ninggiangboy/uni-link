 ...
 * verification token from CreateSessionResponse together with the OTP from email.
 *
...
public class CompleteSessionVerificationUseCase implements UseCaseService {
    ...
    public AuthTokenResponse execute(CompleteSessionVerificationRequest request, String ipAddress) {
        ...
        // Opaque token from CreateSessionUseCase; must decode to the same account/device the OTP was sent for.
