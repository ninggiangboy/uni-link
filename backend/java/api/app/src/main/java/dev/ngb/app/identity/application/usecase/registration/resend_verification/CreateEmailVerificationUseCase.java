...
public class CreateEmailVerificationUseCase implements UseCaseService {

    private final AccountRepository accountRepository;
    private final AccountOtpDeliveryService accountOtpDeliveryService;

    public CreateEmailVerificationResponse execute(CreateEmailVerificationRequest request) {
        ...
        return new CreateEmailVerificationResponse(otp.getUuid());
    }
}
