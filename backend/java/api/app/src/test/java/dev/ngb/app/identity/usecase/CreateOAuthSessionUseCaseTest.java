...
@DisplayName("CreateOAuthSessionUseCase")
class CreateOAuthSessionUseCaseTest {
    ...
    private CreateOAuthSessionRequest request() {
        return new CreateOAuthSessionRequest(AuthProvider.GOOGLE, "provider-jwt", IdentityUseCaseTestFixtures.device());
    }
